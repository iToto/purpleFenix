...
namespace ProjectPrototype
{
    class BossLevel : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            //Load Background
            backgroundTexture = content.Load<Texture2D>("Sprites\\Boss");

            //Load Level
            levelOne = new Map("Content\\Maps\\BossMap.xml", content, "Sprites\\bossTileset", ScreenManager.GraphicsDevice);
